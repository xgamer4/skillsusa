...
public class DPS {
    ...
    /**
     * Creates a DPS player
     * @param username the name of the player
     */
    public DPS(String username){
    ...
    public void getProfScores(){
        System.out.println("    " + username + " - DPS: {DPS Proficiency: " + dps_prof + ", Tank Proficiency: " + tank_prof + ", Supporty Proficiency: " + support_prof + "}");
    } 
